<div class="flex" style="align-items: center;">
    <div class="w50">
        <h2>Base de datos</h2>
        <p>Configura la base de datos para que el programa pueda mostrar e interactuar con los conjuntos de datos que especifiques</p>
    </div>
    ...
    function configure_ges() {
        create_modal([{
            ...
            content: [{
                ...
                name: 'token',
                id: 'clasgestoken',
                value: localStorage.getItem('clasges_token'),
                classList: ['w50']
            }]
        }, {
            type: 'div',
            ...
            content: [{
                ...
                onclick: function() {
                    ...
                    $('#clasgestokenbtn').html('<iconify-icon inline icon="line-md:loading-twotone-loop"></iconify-icon>');
                    let tok = $('#clasgestoken').val()
                    const Clasges = new ClassicGes(tok);
                    Clasges.test().then(r => {
                        localStorage.setItem('clasges_token', tok)
                        $('#clasgestokenbtn').html('<iconify-icon inline icon="akar-icons:check"></iconify-icon>');
                        ...
                        $('#clasgestokenbtn').html('<iconify-icon inline icon="akar-icons:cross"></iconify-icon>');
