...
<div class="flex">
    <div class="input ">
        <input type="text" onchange="$('#sapp').load(localStorage.getItem('current_page')+'?search=' + this.value)" class="input--icon" placeholder="Buscar" style="width: 100%;">
...
<table class="table" id="clients_table">
    ...
    $arr = sql_array('invoices', ['id', 'client', 'date', 'reference', 'total'], ['reference'], get('search'), [['id', 'desc']]);
